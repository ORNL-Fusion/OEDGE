...
csw integration but no scaling of internal photon tallies, just influx
        IF (NPHOTI > 0)
     .    CALL PH_INTEGRATE(ISTRA,FLXFAC(ISTRA)/ELCHA,
