...
!pb  24.11.06: mistyped SGSM_BGK changed to SGMS_BGK
      ...
      SUBROUTINE Ba_gamma (IST,IAD1,IAD2,IAD3,IAD4,IAD5,IADS)
c
...
C
        IR=NREACI+1
        IF (IR.GT.NREAC) THEN
          WRITE (iunout,*) 'FROM SUBROUTINE Ba_gamma: '
...
1000  CONTINUE
      ...
      IF (IST.GT.0)
     .CALL MASBOX('SUBR. Ba_GAMMA CALLED, FOR STRATUM NO. '//CISTRA)
      IF (IST.EQ.0)
     .CALL MASBOX('SUBR. Ba_GAMMA CALLED, FOR SUM OVER STRATA')
      CALL LEER(1)
