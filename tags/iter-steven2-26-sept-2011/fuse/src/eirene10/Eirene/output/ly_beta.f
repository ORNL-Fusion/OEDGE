...
*DK LY_BETA
      SUBROUTINE LY_BETA (IST,IAD1,IAD2,IAD3,IAD4,IAD5,IADS)
c
...
C
        IR=NREACI+1
        IF (IR.GT.NREAC) THEN
          WRITE (IUNOUT,*) 'FROM SUBROUTINE LY_BETA '
...
1000  CONTINUE
      ...
      IF (IST.GT.0)
     .CALL MASBOX('SUBR. LY-BETA CALLED, FOR STRATUM NO. '//CISTRA)
      IF (IST.EQ.0)
     .CALL MASBOX('SUBR. LY-BETA CALLED, FOR SUM OVER STRATA')
      CALL LEER(1)
