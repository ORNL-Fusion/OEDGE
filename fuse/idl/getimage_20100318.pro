...
PRO getimage_20100318,option,plots=plots,scale=scale

  CASE option OF
   1: BEGIN    ; ref                     o/b puff    density ramp
     l_shots  = [24861,24861,24861,24861,24862,24869,24866,24866,24866]
     l_frames = [  343,  554,  762, 1109,  554,  552,  766,  903, 1109]
     l_shots  = [24866]
     l_frames = [  554]
...
;                      maskleft=65,maskbottom=280,maskpoly=maskpoly,maskbox=maskbox)
     END
   2: BEGIN
...
;                      /clean,/save,plots=plots,colour=5,      $
;                      maskleft=115,maskbottom=310,maskbox=maskbox,maskpoly=maskpoly)     
     END
  ENDCASE
...
PRO getimage_20100318_batch,option,plots=plots,scale=scale
 
  getimage_20100318,1,plots=plots,scale=scale
  getimage_20100318,2,plots=plots,scale=scale
  getimage_20100318,3,plots=plots,scale=scale
  getimage_20100318,4,plots=plots,scale=scale
...
; rba 200 us  343 0.158673   603 0.200806  810 0.242206  1158 0.311806
