      ...
      implicit none
      integer :: learc1, ilim, ic1, ic2, is1, is2, izell, izello, is, j,
     .           no, igo, ihit1, ihit2, i
...
! to be seen from everywhere        
          ...
          ELSE
            do izell = 1, nr1st
              CALL BITSET (IGJUM3,0,NOPTIM,IZELL,ILIM,0,NBITS)
            end do
          END IF
...
! find cell index of start point of additional surface
          ic1 = LEARC1(P1(1,ilim),P1(2,ilim),P1(3,ilim),IS1,1,NR1STM,
     .                 .FALSE.,.FALSE.,0,'CUT_ADS_CELL')      

! find cell index of end point of additional surface
          ic2 = LEARC1(P2(1,ilim),P2(2,ilim),P2(3,ilim),IS2,1,NR1STM,
     .               .FALSE.,.FALSE.,0,'CUT_ADS_CELL')
...
! check if additional surface starts or end at a cornerpoint of a triangle
     ...
     .                    (ytrian(necke(i,ic2))-p2(2,ilim))**2) < eps5
          ...
          IF (NLIMPB >= NLIMPS) THEN
            ...
            IGJUM3(IC2,ILIM) = 0
          ELSE
            CALL BITSET (IGJUM3,0,NOPTIM,IC1,ILIM,0,NBITS)
            CALL BITSET (IGJUM3,0,NOPTIM,IC2,ILIM,0,NBITS)
          END IF
