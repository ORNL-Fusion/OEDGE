...
c ======================================================================
c      
c     moved here from out6/src/outplot.f so that it can be called from tau.f
c     for grid_mgroth_81472_aug1122_seq1.bin -SL, 28-Aug-24
c
c     doesn't help... move back..?      
c
      SUBROUTINE REFLECT
      use mod_params
      use mod_cgeom
...
c
c     Moved to utility2.f from utility_com.f for LIM compatibility
c
c
