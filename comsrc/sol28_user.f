...
c....   Low index target:
c        target = LO
c        CALL inPutData(itube,'TUBE','none')
c        CALL inPutData(-1   ,'CELL','none')
c        CALL inPutData(0.0,'s','m')
c        CALL inPutData(-1.0,'sbnd1','m')
c        CALL inPutData(-1.0,'sbnd2','m')
c        CALL inPutData(tube(itube)%ne(target)    ,'NE','m-3')
c        CALL inPutData(tube(itube)%vi(target,ion),'VI','m s-1')
c        rdum = GetCs2(tube(itube)%te(target),tube(itube)%ti(target,ion))
c        CALL inPutData(rdum                      ,'CS','m s-1')
c        CALL inPutData(tube(itube)%te(target)    ,'TE','eV')
c        CALL inPutData(tube(itube)%ti(target,ion),'TI','eV')
c....   Cells centres:
...
c       CALL inPutData(itube,'TUBE','none')
c        CALL inPutData(-1   ,'CELL','none')
c        CALL inPutData(tube(itube)%smax,'s','m')
c        CALL inPutData(-1.0,'sbnd1','m')
c        CALL inPutData(-1.0,'sbnd2','m')
c        CALL inPutData(tube(itube)%ne(target)    ,'ne','m-3')
c        CALL inPutData(tube(itube)%vi(target,ion),'vi','m s-1')
