...
C
      ...
      REAL(DP) :: A, ZCTHET, ZSTHET, ZCPHI, ZSPHI, PI2, RANF, ZTHET
      INTEGER :: J
...
C
      ...
      REAL(DP) :: PI2, ZCOS, ZSIN, ZT, AR, RANF, ZZ
      INTEGER :: JJ
...
C
     ...
     .                        X4, Y4, Z4
      ...
      REAL(DP) :: R1, R2, R3, RMI, RMA, RANF, RCT
C
...
C
      ...
      REAL(DP) :: RANF, A, E, ARG, BETAD2, FTHOMP, EMU
...
C
        DO 8 ISPZ=NSPZI,NSPZE
          DO 8 J=1,NSM
            SP1(ISPZ,J)=VXSTEP(ISPZ,ISTEP,J)
            SP2(ISPZ,J)=VYSTEP(ISPZ,ISTEP,J)
            SP3(ISPZ,J)=VZSTEP(ISPZ,ISTEP,J)
            SP4(ISPZ,J)=DISTEP(ISPZ,ISTEP,J)
            SP5(ISPZ,J)=TISTEP(ISPZ,ISTEP,J)
8       CONTINUE
        DO 9 ISPZ=NSPZI,NSPZE
          DO 9 J=1,NSM
            VXSTEP(ISPZ,ISTEP,J)=SP1(ISPZ,NSM-J+1)
            VYSTEP(ISPZ,ISTEP,J)=SP2(ISPZ,NSM-J+1)
            VZSTEP(ISPZ,ISTEP,J)=SP3(ISPZ,NSM-J+1)
            DISTEP(ISPZ,ISTEP,J)=SP4(ISPZ,NSM-J+1)
            TISTEP(ISPZ,ISTEP,J)=SP5(ISPZ,NSM-J+1)
9       CONTINUE
C
        DO 6 J=1,NSM
