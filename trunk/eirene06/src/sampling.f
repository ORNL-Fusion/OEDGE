...
c slmod begin - debug
c      WRITE(0,*) 'STEP2:',istep,ns,vf(0,istep,ns)
c slmod end
...
994   CONTINUE
      ...
      DO 995 I=1,J
c slmod begin - debug
        WRITE (iunout,'(1X,I3,1P,5(2E12.4,2X))') 
     .         I,RRSTEP(ISTEP,I),(VF    (IS,ISTEP,I  ),
     .                            FLSTEP(IS,ISTEP,I-1),IS=NSPZI,NSPZE)
c
c        WRITE (iunout,'(1X,I3,1P,5E12.4)') 
c     .         I,RRSTEP(ISTEP,I),(VF(IS,ISTEP,I),IS=NSPZI,NSPZE)
c slmod end
995   CONTINUE
      CALL EXIT_OWN(1)
      END
