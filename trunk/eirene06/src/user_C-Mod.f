...
c...        Momentum source [???]:
            ...
            WRITE(6,'(A,2I6,1P,2E10.2)') 
     .        'COPV:',inc,ir,COPV(IADD+IPLS,INC),vol(ir)
...
c...      Plasma quantities:
          ...
          DDUM(11)=VXIN(IPLS,IR)                                     ! Velocity [...]
          DDUM(12)=VYIN(IPLS,IR)
          DDUM(13)=VZIN(IPLS,IR)
          DDUM(14)=BVIN(IPLSV,IR)                                    ! Velocity parallel to B[...]
          DDUM(15)=TIIN(IPLS,IR)                                     ! Temperature (yes?) [...]
