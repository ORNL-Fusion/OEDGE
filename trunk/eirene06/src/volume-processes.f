...
!pb       WRITE (iunout,*) 'WARNING FROM SUBR. CDEF '
!pb       WRITE (iunout,*) 'PLASMA TEMPERATURE OUT OF SAVE RANGE FOR'
!pb       WRITE (iunout,*) 'RATE COEFFICIENT NR. ',K, exp(al)
!pb       WRITE (iunout,*) 'CONSULT D.REITER '
!pb     ENDIF
        SELECT CASE (IFCLF)
        CASE (1)
