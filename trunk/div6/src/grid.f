...
c
      ...
      character*256 :: ident_file,intersection_file
      integer :: ierr
     ...
     >       rs,zs,
      ...
      ! neutral wall - need lots of points for this since 400 rings have 800 endpoints
      rves
      zves

      ! may need to add grid mapping data to make it possible to calculate these in the grid generator
