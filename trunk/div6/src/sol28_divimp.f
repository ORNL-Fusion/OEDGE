...
c
      DO i = 1, nsputter
        ...
        IF (sputter_data(i)%type.EQ.3.OR.     ! yield is already calculated
     .      sputter_data(i)%type.EQ.5) CYCLE  ! loading impurity launch/injection distribution from a previous run
