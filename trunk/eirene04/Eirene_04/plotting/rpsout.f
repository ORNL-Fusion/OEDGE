         ...
         do ir=1,nr1st-1
            do ip=1,np2nd-1
               do it=1,nt3rd-1
                  ...
                  WRITE(18,'(1X,A1,8I6)') '0',ird1,ird2,ird3,ird4,
     .                                        ird5,ird6,ird7,ird8
               enddo
            enddo
         enddo
...
40        CONTINUE
          ...
          if (lraps3d.and.lr3dcon) then
            if (ipl < iplane-1) then
              ...
              DO I=1,NTRII
                WRITE(18,'(1X,A1,6I6)') '0',NECKE(1,I)+ipl*nrknot,
     ...
     .                                      NECKE(3,I)+(ipl+1)*nrknot
            ...
            DO 60 I=1,NTRII
              WRITE(18,'(1X,A1,3I6)') '0',NECKE(1,I)+ipl*nrknot,
     .                                    NECKE(2,I)+ipl*nrknot,
     .                                    NECKE(3,I)+ipl*nrknot
60          CONTINUE
            igroups = iplane
...
C TO BE DONE: NSTGRD.NE.0 AUSBLENDEN, ANZ NEU BERECHENEN.
        ...
        do i=1,ntet
          if (ntbar(1,i) >= 0)
     .      WRITE(18,'(1X,A1,4I6)') '0',NTECK(1,I),NTECK(2,I),
     .                                  NTECK(3,I),NTECK(4,I)    
        enddo
      ELSE
      ENDIF
...
C
      if ((levgeo == 3) .or. (levgeo == 4) .and. lraps3d ) then
        if (ncontour > 0) then
