...
c     jdemod
c
c     The MCLOCK function on the INTEL compiler, according to documentation,
c     is supposed to return the run time in micro-seconds and not 100ths of seconds.
c     However, clocking information from Karl seems to show a 10x larger run time
c     report from DIVIMP than expected which would be indicative of a value in 
c     milliseconds - so for the time being I am changing the division to 1000.0
c     instead of 100.0.
c
      I = MCLOCK()
      ZA02AS = I/1000.0
