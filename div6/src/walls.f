...
!         write(0,*) 'ITMP3:',itmp,nves
     ...
     >        ' EACH TARGET')
         call errmsg('ERROR:WALLS:NEARWALL2:',
     >        'THIS ERROR CAN BE TRIGGERED BY INCORRECT TARGET'//
     >     ' CORNER COORDINATES FROM INCORRECT SONNET GRID SUB TYPE:'//
     >   ' CHECK INPUT *G23 (OPT 0 HAS BOUNDARY CELLS, OPT 2 DOES NOT)')
