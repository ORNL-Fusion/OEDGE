...
C
C  USE X-OR RADIAL DISTRIBUTION OF ION FLUX 0.5*NI(R,Y0,Z0)*CS(R,Y0,Z0)*(DELTA-Z) (AMP/CM)
...
C  Y0:
            ...
            ELSEIF (INDIM(ISRFS,ISTRA).EQ.3.AND.NLTOR) THEN
              ...
              WRITE (6,*) 'SAMPLING OF RADIAL (OR X-) CO-ORDINATE '
              WRITE (6,*) 'ON A POLOIDAL (OR Y-) SURFACE '
              WRITE (6,*) 'DEFINE STEP FUNCTION ELSEWHERE, ',
     .                    'EG. IN SAMUSR'
              WRITE (6,*) 'CALL EXIT '
              CALL EXIT_OWN(1)
            ENDIF
