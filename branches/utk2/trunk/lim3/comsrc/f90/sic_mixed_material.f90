...
!  end subroutine print_sic_yields_mm
  ...
  real function yield_mm(energy, cion, frac_c, mm_usage)
    ...
    real :: energy, frac_c, yield_sic_si, yield_sic_c, yield_si
    ...
    yield_si = &
      ...
      lin_interp(energy, d_si_ch_e, d_si_ch_yields, &
        n_d_si_ch, 1) + &
      frac_c * lin_interp(energy, c_si_e, c_si_yields, &
        n_c_si, 1)
