...
C       WRITE (6,*) 'INITIAL: X0,X01,Z01,PHI ',X0,X01,Z01,PHI/DEGRAD
C     ENDIF
C
...
C           IF (NLTRC) WRITE (6,*) 'CHECK VALID RANGE: Z0TEST ',Z0TEST
          ...
          NINCZ=0
C         IF (NLTRC) THEN
C           WRITE (6,*) 'NO REENTRY INTO TOROIDAL GRID FOUND '
C         ENDIF
          Z01=Z01+ZRD*VELZ
          GOTO 5000
        ENDIF
...
C                      FOR A POLOIDAL SURFACE (OTHERWISE: ERROR EXIT)
      ...
      BLPD(1)=ZRAD
C     IF (NLTRC) WRITE (6,*) 'FINAL 1: X01,Z01,PHI ',X01,Z01,PHI/DEGRAD
      GOTO 5000
C
...
C
C     IF (NLTRC) THEN
C       WRITE (6,*) 'FINAL 2: X01,Z01,PHI ',X01,Z01,PHI/DEGRAD
C       WRITE (6,*) 'ZRAD,ISRFCL,IPERID ',ZRAD,ISRFCL,IPERID
C     ENDIF
      GOTO 5000
C
...
C
C     IF (NLTRC) THEN
C       WRITE (6,*) 'FINAL 3: X01,Z01,PHI ',X01,Z01,PHI/DEGRAD
C       WRITE (6,*) 'ZRAD,ISTS,ISRFCL,IPERID ',ZRAD,ISTS,ISRFCL,IPERID
C     ENDIF
      GOTO 5000
C
...
C       WRITE (6,*)  MTSURF,NLSRFZ,NINCZ,IRCELL,IPCELL
C       IF (NLTOR) WRITE (6,*) 'INMP3I ',INMP3I(IRCELL,IPCELL,MTSURF)
C     ENDIF
C
      NCOU=NCOUT
C
