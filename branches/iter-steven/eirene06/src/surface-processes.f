...
C
      ENTRY REFLC0
      IF (debug) WRITE(0,*) 'DEBUG: REFLEC0 1.00'
C
...
C
      IF (debug) WRITE(0,*) 'DEBUG: REFLEC0 1.01',NLDATA
      IF (NLDATA) THEN
C
        if (my_pe .eq. 0) then
          IF (NLTRIM) THEN
...
C
      IF (debug) WRITE(0,*) 'DEBUG: REFLEC0 1.02',NLBEHR
      IF (NLBEHR) THEN
C
...
C
      IF (debug) WRITE(0,*) 'DEBUG: REFLEC0 1.03',trcref
      IF (TRCREF) THEN
        WRITE (iunout,*) 
...
22      CONTINUE
      ...
      ENDIF
C
      IF (debug) WRITE(0,*) 'DEBUG: REFLEC0 1.04'
      CALL RF0USR
      IF (debug) WRITE(0,*) 'DEBUG: REFLEC0 DONE'
C
      RETURN
C
      ENTRY REFLC1 (WMIN,XMP,XCP,NPRIN,IGASF,IGAST)
      IF (debug) WRITE(0,*) 'DEBUG: REFLEC1 1.00'
C
...
C
      IF (debug) WRITE(0,*) 'DEBUG: REFLEC1 1.10',MODREF
      IF (MODREF.EQ.1) THEN
        GOTO 100
...
C
100   CONTINUE
      IF (debug) WRITE(0,*) 'DEBUG: REFLEC1 1.11 TRIM'
C
...
c      IF (msurf.EQ.12) WRITE(0,*) 'debug rprob:',ispz,msurf,rprob,prfct
      IF (debug) WRITE(0,*) 'DEBUG: REFLEC1 1.13',fr1,rprob
...
C
      ...
      WRITE(0,*) 'DEBUG 702:',SIZE(hftr2,2)
      WRITE(0,*) 'DEBUG 702:',indep,indwp,indr1,indr2p,ifile
      RF6=RF6+RO1*(HFTR2(INDEP,INDWP,INDR1,INDR2P,IFILE)-RF6)
      WRITE(0,*) 'DEBUG 702 done'
