...
;help,wall,/struct
      ...
      IF (KEYWORD_SET(wall)) THEN file = wall.file     ELSE  $
                                  file = val.wall.file
...
stop
          ...
          FOR istate = 1, data_set.max_charge DO BEGIN
            ...
            CASE iplot OF
              ...
              2:
              3: BEGIN
                ydata[*,itrace] = sputter.modifier * data_set.flux [*,itrace]
                net_flux = net_flux + TOTAL( data_set.flux [*,itrace] * sputter.length )

; *** LEFT OFF *** Need to multiply by the ABSFAC From the code run... is that going to work?  I think no!  Since the integraly of FLUX is not 1!
; argh! am I doing anything right!?

                END
              4: ydata[*,itrace] = sputter.modifier * data_set.e0   [*,itrace]
              5: ydata[*,itrace] = sputter.modifier * data_set.flux [*,itrace] * data_set.yield[*,itrace]
              6: BEGIN
            ...
            IF (iplot EQ 3 OR iplot EQ 6) THEN BEGIN
