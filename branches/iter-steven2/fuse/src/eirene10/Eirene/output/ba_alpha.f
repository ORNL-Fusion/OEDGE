...
c        (fulcher contribution still in old halpha.f) 
      ...
      SUBROUTINE Ba_alpha (IST,IAD1,IAD2,IAD3,IAD4,IAD5,IADS)
c
...
C
        IR=NREACI+1
        IF (IR.GT.NREAC) THEN
          WRITE (iunout,*) 'FROM SUBROUTINE Ba_alpha: '
...
1000  CONTINUE
      ...
      IF (IST.GT.0)
     .CALL MASBOX('SUBR. BA_ALPHA CALLED, FOR STRATUM NO. '//CISTRA)
      IF (IST.EQ.0)
     .CALL MASBOX('SUBR. BA_ALPHA CALLED, FOR SUM OVER STRATA')
      CALL LEER(1)
