...
C   GENERATION LIMIT
      IF (.NOT.LPGENPH) THEN
        CALL MASAGE ('PHOTS ABSORBED DUE TO GENERATION-OR FLUID LIMIT')
...
C  PHOTON PLASMA INTERACTION
     ...
     .                LOGPLS,ISTRA,0,NPLS,0,NSTRA,TEXTS(NSPAMI+1))
      ...
      ENDIF
      IF (.NOT.LPPPL) THEN
        CALL MASAGE ('BULK IONS BORN BY BULK ION PLASMA INTERACTIONS ')
...
C
      ...
      ENDIF
      IF (.NOT.LEPPL) THEN
        CALL MASAGE ('ENERGY GAIN FROM BULK ION PLASMA INTERACTIONS')
...
C
      ...
      IF (SUM(ABS(CEMETERYV)) > 0._DP) THEN
        CALL LEER(2)
        WRITE (6,*) ' CEMETERYV != 0 '
        WRITE (6,*) ' CHECK SUBROUTINE UPDATE FOR BUGS! '
        CALL LEER(2)
      END IF
C
