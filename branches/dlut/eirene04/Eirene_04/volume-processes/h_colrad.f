...
C
      ...
      RETURN
 1000 WRITE(6,*) 'ERROR IN COFJO        ICON = ',ICON
      STOP
      END
...
C     WRITE (6,10) II,S,ERR,N,ICON
C  10 FORMAT(1H ,1I3,2(2X,1PD10.3),2X,I4,2X,I5,/)

      RETURN
C1000 WRITE(6,*) 'ERROR IN CLBETA       ICON = ',ICON
C     STOP
      END
...
c
      ...
      if (ier.eq.1) then
        write (6,*) 'error in lax, matrix ist singulaer'
      endif
      return
      end
c
