...
#
      ...
      SHELL = /bin/bash
   GLI_HOME = "/home/marandet/Documents/graph_lib_eirene/grgli/gks"
         CC = gcc
     CFLAGS = -g
        F77 = gfortran
   F77FLAGS = -static
...
pclinux-nagware:
	...
	LD="pgf90 -shared " \
	LDFLAGS="-L/usr/local/NAGWare_f95/lib -ifc8.1 -u MAIN__" \
	LIBS="-lgks"
pclinux-pgf90:
...
pclinux-intel_8.1:
	...
	LIBS="-lgks"
pclinux-intel_9.1:
	@make libgr.a F77="ifort" \
	CFLAGS="-I$(GLI_HOME) -m64" \
	F77FLAGS="-m64 -g" \
	F90="ifort" \
	F90FLAGS="-m64 -g" \
	RANLIB="ranlib" \
	BLDFLAG="ar" \
	SEGLD="cc" \
	XLIBS="-L/usr/lib64 -lXt -lXext -lX11" \
	LD="ifort" \
	LDFLAGS=" " \
	LIBS="-lgks"
pclinux-gnu:
	@make libgr.a F77="gfortran" \
	CFLAGS="-I$(GLI_HOME) -m64" \
	F77FLAGS="-g -m64" \
	F90="gfortran" \
	F90FLAGS="-g -m64" \
