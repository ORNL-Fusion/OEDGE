...
C***********************************************************************
C-UEBERALL AENDERN_C@PROCESS NOSDUMP NOGOSTMT OPT(3) FIPS(F)
C     DEBUG SUBCHK
C     END DEBUG
...
cjh      EXTERNAL          GR3DZN,GR3OUT,GR3PFL,GR3PLT,GRNWPN,GRSPTS
...
*
cjh      ELSE
cjh         CALL GR3OUT(A,A(ISY),A(ISZ),IP0,A(IF1),A(IF2),A(IF3),A(IF4),
cjh     $               MNF,IF0,A(IL),A(LQ),MNL,IL0,LW)
      END IF
*
      IF (ZENPRO) THEN
