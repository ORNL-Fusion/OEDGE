...
for i=1:16
   ...
   zone(i).neightype=zeros(Nx,Nz,2,3);
   for k=1:Nx
       for j=1:Nz
           ...
           if(k==1)
            ...
            zone(i).neightri(k,j,1,2)=zone(i).triangles(k,j,2);
           
            if(k==Nx)
               if(B(1)==1) %BC au nord
                  zone(i).neightri(k,j,1,2)=0;
                  zone(i).neightype(k,j,1,2)=1;
               else
...
%                 zone(i).neightri(k,j,1,3),1,zone(i).neightype(k,j,1,3),0,0]];
            ...
            fprintf(fid,'%d\t',3);
            fprintf(fid,'%d\t',zone(i).neightype(k,j,1,1));
            %deuxieme voisin
            fprintf(fid,'%d\t',zone(i).neightri(k,j,1,2));
            fprintf(fid,'%d\t',2);
            fprintf(fid,'%d\t',zone(i).neightype(k,j,1,2));
            %troisieme voisin
            fprintf(fid,'%d\t',zone(i).neightri(k,j,1,3));
            fprintf(fid,'%d\t',1);
            fprintf(fid,'%d\t',zone(i).neightype(k,j,1,3));
            %coordonnée ???
            fprintf(fid,'%d\t',0);
            fprintf(fid,'%d\n',0);
...
%                 zone(i).neightri(k,j,1,3),1,zone(i).neightype(k,j,1,3),0,0]];
            ...
            fprintf(fid,'%d\t',3);
            fprintf(fid,'%d\t',zone(i).neightype(k,j,2,1));
            %deuxieme voisin
            fprintf(fid,'%d\t',zone(i).neightri(k,j,2,2));
            fprintf(fid,'%d\t',2);
            fprintf(fid,'%d\t',zone(i).neightype(k,j,2,2));
            %troisieme voisin
            fprintf(fid,'%d\t',zone(i).neightri(k,j,2,3));
            fprintf(fid,'%d\t',1);
            fprintf(fid,'%d\t',zone(i).neightype(k,j,2,3));
            %coordonnée ???
            fprintf(fid,'%d\t',0);
            fprintf(fid,'%d\n',0);
