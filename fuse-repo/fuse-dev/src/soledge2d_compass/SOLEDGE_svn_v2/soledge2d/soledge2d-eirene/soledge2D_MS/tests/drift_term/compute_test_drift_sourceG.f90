subroutine compute_test_drift_sourceG(k)
  use test_var
  ...
  do i=1,Nx
	...
	s1 = 1/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))
  	s4 = a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi)/(-a*(0.6D0+0.8D0*psi)*sin(theta+psi*thetashift*pi)*(0.8D0*a*sin(theta+psi*thetashift*pi)+&
		...
		(0.8D0*a*cos(theta+psi*thetashift*pi)-a*(0.6D0+0.8D0*psi)*sin(theta+psi*thetashift*pi)*thetashift*pi)
	...
	s3 = s4+s5
	s7 = -2*G0*cos(theta)*cos(2*pi*psi)*pi
	...
	s10 = (2*B0**2*R0**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**3*a*(0.6D0+0.8D0*psi)*sin(theta+psi*thetashift*pi)+2*psi0**2/a/&
		(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**3*sin(theta+psi*thetashift*pi)**3*(0.6D0+0.8D0*psi)+2*psi0**2/a/(R0+a*(0.6D0+0.8D0*psi)*&
		cos(theta+psi*thetashift*pi))**3*cos(theta+psi*thetashift*pi)**2*(0.6D0+0.8D0*psi)*sin(theta+psi*thetashift*pi))*B0*R0
	s8 = s9*s10
	s6 = s7*s8
	s9 = -0.2D0*G0*cos(theta)**2*sin(2*pi*psi)*T0
	s11 = cos(2*pi*psi)*pi/(B0**2*R0**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**2+psi0**2/a**2/(R0+a*(0.6D0+0.8D0*psi)*&
		cos(theta+psi*thetashift*pi))**2*sin(theta+psi*thetashift*pi)**2+psi0**2/a**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**2*&
		cos(theta+psi*thetashift*pi)**2)**2
	s12 = (2*B0**2*R0**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**3*a*(0.6D0+0.8D0*psi)*sin(theta+psi*thetashift*pi)+2*psi0**2/a/&
		(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**3*sin(theta+psi*thetashift*pi)**3*(0.6D0+0.8D0*psi)+2*psi0**2/a/(R0+a*(0.6D0+0.8D0*psi)*&
		cos(theta+psi*thetashift*pi))**3*cos(theta+psi*thetashift*pi)**2*(0.6D0+0.8D0*psi)*sin(theta+psi*thetashift*pi))*B0*R0
	s10 = s11*s12
	s8 = s9*s10
	s10 = -G0*cos(theta)*sin(2*pi*psi)
	s12 = (T0+0.1D0*T0*cos(theta)*sin(2*pi*psi))/(B0**2*R0**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**2+psi0**2/a**2/(R0+a*(0.6D0+0.8D0*psi)*&
		cos(theta+psi*thetashift*pi))**2*sin(theta+psi*thetashift*pi)**2+psi0**2/a**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**2*&
		cos(theta+psi*thetashift*pi)**2)**2
	...
	s5 = s6+s7
	s7 = s5
	s9 = -G0*sin(theta)*sin(2*pi*psi)
	s11 = (T0+0.1D0*T0*cos(theta)*sin(2*pi*psi))/(B0**2*R0**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**2+psi0**2/a**2/&
		(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**2*sin(theta+psi*thetashift*pi)**2+psi0**2/a**2/(R0+a*(0.6D0+0.8D0*psi)*&
	...
	s6 = s7+s8
	s7 = s6
	s10 = -0.1D0*G0*cos(theta)*sin(2*pi*psi)**2*T0
	s12 = sin(theta)/(B0**2*R0**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**2+psi0**2/a**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**2*&
		sin(theta+psi*thetashift*pi)**2+psi0**2/a**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**2*cos(theta+psi*thetashift*pi)**2)**2
	s13 = (-2*B0**2*R0**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**3*(0.8D0*a*cos(theta+psi*thetashift*pi)-a*(0.6D0+0.8D0*psi)*&
		sin(theta+psi*thetashift*pi)*thetashift*pi)-2*psi0**2/a**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**3*sin(theta+psi*thetashift*pi)**2*&
		(0.8D0*a*cos(theta+psi*thetashift*pi)-a*(0.6D0+0.8D0*psi)*sin(theta+psi*thetashift*pi)*thetashift*pi)-2*psi0**2/a**2/(R0+a*(0.6D0+0.8D0*psi)*&
	...
	s11 = s12*s13
	s9 = s10*s11
	s11 = G0*cos(theta)*sin(2*pi*psi)*(T0+0.1D0*T0*cos(theta)*sin(2*pi*psi))
	...
	s16 = -6*B0**2*R0**2/(R0+a*(0.6D0+0.8D0*psi)*cos(theta+psi*thetashift*pi))**4*a*(0.6D0+0.8D0*psi)*sin(theta+psi*thetashift*pi)*(0.8D0*a*cos(theta+psi*thetashift*pi)-&
		...
		cos(theta+psi*thetashift*pi))**4*sin(theta+psi*thetashift*pi)**3*(0.6D0+0.8D0*psi)*(0.8D0*a*cos(theta+psi*thetashift*pi)-&
		a*(0.6D0+0.8D0*psi)*sin(theta+psi*thetashift*pi)*thetashift*pi)
	...
	s4 = s7+s8
	s2 = s3*s4
	test_sources(k,1)%SG(i,j) = test_sources(k,1)%SG(i,j) + s1*s2
	! Adim
        test_sources(k,1)%SG(i,j)= test_sources(k,1)%SG(i,j)/(reference_parameters%fields%n0*reference_parameters%fields%c0/reference_parameters%fields%tau0)
     end do
  end do
end subroutine compute_test_drift_sourceG
