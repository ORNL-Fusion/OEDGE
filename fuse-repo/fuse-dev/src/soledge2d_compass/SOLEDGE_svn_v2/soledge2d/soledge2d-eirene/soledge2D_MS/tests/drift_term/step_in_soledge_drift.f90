subroutine step_in_soledge_drift()
  use all_variables
  use test_var
  use Mdefinitions
  implicit none
  ...
  do k=1,global_parameters%N_zones
     call compute_perp_velocity(zones(k))					
  end do
  call Broadcast_drift()
  ...
  do k=1,global_parameters%N_zones
     ...
     call compute_explicit_drift_perp_source_terms(zones(k))
  end do
  ...
  do k=1,global_parameters%N_zones
     ...
     call compute_density_source(zones(k))
  ...
  do k=1,global_parameters%N_zones
     ...
     call compute_velocity_source(zones(k))
  ...
  do k=1,global_parameters%N_zones
     ...
     call compute_temperature_source(zones(k))
...
end subroutine step_in_soledge_drift
