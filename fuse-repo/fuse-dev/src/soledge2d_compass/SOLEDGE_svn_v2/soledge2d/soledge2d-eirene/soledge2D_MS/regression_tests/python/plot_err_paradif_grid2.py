...
plt.title('Parallel diffusion - Absolute error / Grid2')
plt.xlabel('Grid resolution')
plt.ylabel('Truncation error')
plt.savefig('errors/err_abs_para_grid2.png')
...
plt.grid(True,which="both",ls="-")
plt.legend([line_T, line_Te],['Ti','Te'])
plt.title('Parallel diffusion - Relative error / Grid2')
plt.xlabel('Grid resolution')
plt.ylabel('Truncation error')
plt.savefig('errors/err_rel_para_grid2.png')
