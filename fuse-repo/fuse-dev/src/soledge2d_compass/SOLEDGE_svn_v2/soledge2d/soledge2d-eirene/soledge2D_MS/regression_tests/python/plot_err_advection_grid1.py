...
plt.title('Parallel advection - Absolute error / Grid1')
plt.xlabel('Grid resolution')
plt.ylabel('Truncation error')
plt.savefig('errors/err_abs_adv_grid1.png')
...
plt.grid(True,which="both",ls="-")
plt.legend([line_n, line_G, line_T, line_Te],['Density','Velocity','Ti','Te'])
plt.title('Parallel advection - Relative error / Grid1')
plt.xlabel('Grid resolution')
plt.ylabel('Truncation error')
plt.savefig('errors/err_rel_adv_grid1.png')
