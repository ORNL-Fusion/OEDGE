...
plt.title('Drift test - Absolute error / Grid1')
plt.xlabel('Grid resolution')
plt.ylabel('Truncation error')
plt.savefig('errors/err_abs_drift_grid1.png')
...
plt.grid(True,which="both",ls="-")
plt.legend([line_n, line_G, line_T, line_Te],['Density','Velocity','Ti','Te'])
plt.title('Drift test - Relative error / Grid1')
plt.xlabel('Grid resolution')
plt.ylabel('Truncation error')
plt.savefig('errors/err_rel_drift_grid1.png')
