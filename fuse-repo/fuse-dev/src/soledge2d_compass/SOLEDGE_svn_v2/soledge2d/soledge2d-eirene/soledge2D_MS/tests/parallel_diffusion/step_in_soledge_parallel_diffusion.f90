subroutine step_in_soledge_parallel_diffusion()
  use all_variables
  use test_var
  use Mdefinitions
  implicit none
  ...
  do k=1,global_parameters%N_zones
     ...
     call add_temperature_matrix_para_diffusion(zones(k))
...
end subroutine step_in_soledge_parallel_diffusion
