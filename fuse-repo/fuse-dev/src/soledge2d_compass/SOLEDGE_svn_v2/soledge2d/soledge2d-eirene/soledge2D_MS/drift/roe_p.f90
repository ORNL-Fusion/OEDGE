SUBROUTINE ROE_p(Nx,Nz,LM,LP,FM,FP,OMM,OMP,EIGENM,EIGENP)
  IMPLICIT NONE
  INTEGER*4 :: Nx,Nz
  REAL*8,DIMENSION(0:Nx,1:Nz,1:3),intent(in) :: LM,LP,FM,FP,OMM,OMP
  real*8,dimension(0:Nx,1:Nz,1:3),intent(out):: EIGENM,EIGENP
  INTEGER*4 i,j,k
  REAL*8 ALPHA
  DO k=1,3
     DO I=0,Nx
