subroutine compute_test_collision_sourceT1(k)
  use test_var
  ...
  do i=1,Nx
     do j=1,Nz
        ...
        test_sources(k,1)%ST(i,j)=0.d0

        s1 = q1*G0*cos(theta)
        s3 = sin(2*pi*(r-rmin)/(rmax-rmin))
        ...
        s9 = 1/m1*(0.15D1*n0+0.15D0*n0*cos(theta)*sin(2*pi*(r-rmin)/(rmax-&
             ...
             *pi*(r-rmin)/(rmax-rmin)))*eV/m1)**3*(3*G0*cos(theta)*sin(2*pi*(r-rmin)&
        ...
        s9 = 1/m1*(0.15D1*n0+0.15D0*n0*cos(theta)*sin(2*pi*(r-rmin)/(rmax-&
             ...
             *(r-rmin)/(rmax-rmin)))*eV/m1)**3*(3*G0*cos(theta)*sin(2*pi*(r-&
        ...
        s10 = 1/((0.2D1*n0+0.2D0*n0*cos(theta)*sin(2*pi*(r-rmin)/(rmax-rmin)&
             ...
             *sin(theta)**2+psi0**2/a**2/(R0+r*cos(theta))**2*cos(theta)**2)*T0&
             *sin(theta)*sin(2*pi*(r-rmin)/(rmax-rmin)))*eV
        s8 = s9*s10
        s6 = s7+s8
        s8 = s6
        s10 = -0.425D-1*(m0/m2+m2/m0)*(0.2D1*n0+0.2D0*n0*cos(theta)*sin(2*&
        ...
        s6 = s7+s8
        s8 = s6
        s10 = -0.425D-1*(m0/m2+m2/m0)*(0.2D1*n0+0.2D0*n0*cos(theta)*sin(2*pi&
...
end subroutine compute_test_collision_sourceT1
