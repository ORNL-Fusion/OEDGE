...
!!$           zones(k)%species(Nspec)%drifts%uEp(1:Nx,Nz)=zones(k)%species(Nspec)%drifts%uEp(1:Nx,Nz-1)
!!$           zones(k)%species(Nspec)%drifts%udp(1:Nx,Nz)=zones(k)%species(Nspec)%drifts%udp(1:Nx,Nz-1)
!!$           zones(k)%species(Nspec)%drifts%uBp(1:Nx,Nz)=zones(k)%species(Nspec)%drifts%uBp(1:Nx,Nz-1)
!!$           zones(k)%species(Nspec)%drifts%uEt(1:Nx,Nz)=zones(k)%species(Nspec)%drifts%uEt(1:Nx,Nz-1)
!!$           zones(k)%species(Nspec)%drifts%udt(1:Nx,Nz)=zones(k)%species(Nspec)%drifts%udt(1:Nx,Nz-1)
!!$           zones(k)%species(Nspec)%drifts%uBt(1:Nx,Nz)=zones(k)%species(Nspec)%drifts%uBt(1:Nx,Nz-1)
...
!!$           zones(k)%species(Nspec)%drifts%uEp(1:Nx,1)=zones(k)%species(Nspec)%drifts%uEp(1:Nx,2)
!!$           zones(k)%species(Nspec)%drifts%udp(1:Nx,1)=zones(k)%species(Nspec)%drifts%udp(1:Nx,2)
!!$           zones(k)%species(Nspec)%drifts%uBp(1:Nx,1)=zones(k)%species(Nspec)%drifts%uBp(1:Nx,2)
!!$           zones(k)%species(Nspec)%drifts%uEt(1:Nx,1)=zones(k)%species(Nspec)%drifts%uEt(1:Nx,2)
!!$           zones(k)%species(Nspec)%drifts%udt(1:Nx,1)=zones(k)%species(Nspec)%drifts%udt(1:Nx,2)
!!$           zones(k)%species(Nspec)%drifts%uBt(1:Nx,1)=zones(k)%species(Nspec)%drifts%uBt(1:Nx,2)
...
end subroutine Broadcast_drift2
