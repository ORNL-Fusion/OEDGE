SUBROUTINE ROE_p_e(Nx,Nz,LM,LP,FM,FP,OMM,OMP,EIGENM,EIGENP)
  IMPLICIT NONE
  INTEGER*4 :: Nx,Nz
  REAL*8,DIMENSION(0:Nx,1:Nz),intent(in) :: LM,LP,FM,FP,OMM,OMP
  real*8,dimension(0:Nx,1:Nz),intent(out):: EIGENM,EIGENP
  INTEGER*4 i,j,k
  REAL*8 ALPHA
  DO I=0,Nx
     do j=1,Nz
