...
plt.title('Perpendicular diffusion - Absolute error / Grid2')
plt.xlabel('Grid resolution')
plt.ylabel('Truncation error')
plt.savefig('errors/err_abs_perp_grid2.png')
...
plt.grid(True,which="both",ls="-")
plt.legend([line_n, line_G, line_T, line_Te],['Density','Velocity','Ti','Te'])
plt.title('Perpendicular diffusion - Relative error / Grid2')
plt.xlabel('Grid resolution')
plt.ylabel('Truncation error')
plt.savefig('errors/err_rel_perp_grid2.png')
