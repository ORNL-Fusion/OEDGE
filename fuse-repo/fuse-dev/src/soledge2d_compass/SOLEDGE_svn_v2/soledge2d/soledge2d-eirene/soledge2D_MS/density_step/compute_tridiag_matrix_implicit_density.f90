subroutine compute_tridiag_matrix_implicit_density(zone)
...
end subroutine compute_tridiag_matrix_implicit_density


subroutine compute_tridiag_matrix_implicit_density_point(zone,i,j,n)
  use all_variables, only : global_parameters, reference_parameters,&
       global_variables
  use Mzone
  use Mphysics
...
end subroutine compute_tridiag_matrix_implicit_density_point
