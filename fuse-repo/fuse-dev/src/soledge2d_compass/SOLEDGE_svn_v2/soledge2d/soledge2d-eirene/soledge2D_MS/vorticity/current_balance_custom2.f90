subroutine current_balance_custom2(zone,i)
  ...
  open(unit=101,file='north_j2',status='unknown')
  open(unit=102,file='south_j2',status='unknown')
  open(unit=103,file='east_j2',status='unknown')
  open(unit=104,file='west_j2',status='unknown')
  open(unit=105,file='div_j2',status='unknown')
  do j=1,Nz
...
end subroutine current_balance_custom2
