module init_test_mod_drift

contains
  subroutine init_test_drift(level,element,temperature,plasma_type)
    use all_variables
    use test_var
    use Mlog_message
    implicit none
    ...
    call set_test_soledge_drift_parameters(element,temperature)
  ...
  end subroutine init_test_drift
end module init_test_mod_drift
