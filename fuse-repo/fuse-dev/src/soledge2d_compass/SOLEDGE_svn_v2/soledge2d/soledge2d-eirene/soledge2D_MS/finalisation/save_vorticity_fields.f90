subroutine save_vorticity_fields()
...
#include "compile_opt.inc"
  ...
  do k=1,global_parameters%N_zones
     ...
     call h5screate_simple_f(2,dim2d,dspace_id,error)
     call h5dcreate_f(group_id,"phi_smooth",H5T_NATIVE_DOUBLE,dspace_id,dataset_id,error)
     call h5dwrite_f(dataset_id,H5T_NATIVE_DOUBLE,zones(k)%electric_fields(1)%phi_smooth,dim2d,error)
     call h5dclose_f(dataset_id,error)
     call h5sclose_f(dspace_id,error)
     call h5screate_simple_f(2,dim2d,dspace_id,error)
     ...
     call h5sclose_f(dspace_id,error)
     call h5screate_simple_f(2,dim2d,dspace_id,error)
     call h5dcreate_f(group_id,"Eparallel",H5T_NATIVE_DOUBLE,dspace_id,dataset_id,error)
     call h5dwrite_f(dataset_id,H5T_NATIVE_DOUBLE,zones(k)%electric_fields(1)%E,dim2d,error)
     call h5dclose_f(dataset_id,error)
     call h5sclose_f(dspace_id,error)
  ...
  if(flags%use_triangles) then
     ...
     call h5dcreate_f(group_id,"phi",H5T_NATIVE_DOUBLE,dspace_id,dataset_id,error)
     call h5dwrite_f(dataset_id,H5T_NATIVE_DOUBLE,interp_data2%knots_phi(:),dim1d,error)
     call h5dclose_f(dataset_id,error)
     call h5sclose_f(dspace_id,error)        
     call h5screate_simple_f(1,dim1d,dspace_id,error)
     call h5dcreate_f(group_id,"vorticity",H5T_NATIVE_DOUBLE,dspace_id,dataset_id,error)
     call h5dwrite_f(dataset_id,H5T_NATIVE_DOUBLE,interp_data2%knots_vorticity(:),dim1d,error)
     call h5dclose_f(dataset_id,error)
     call h5sclose_f(dspace_id,error)        
     call h5screate_simple_f(1,dim1d,dspace_id,error)
     call h5dcreate_f(group_id,"Eparallel",H5T_NATIVE_DOUBLE,dspace_id,dataset_id,error)
     call h5dwrite_f(dataset_id,H5T_NATIVE_DOUBLE,interp_data2%knots_Epara(:),dim1d,error)
     call h5dclose_f(dataset_id,error)
     call h5sclose_f(dspace_id,error)        
     call h5gclose_f(group_id,error)
  end if
...
end subroutine save_vorticity_fields
