...
cccccccc yannick: reinitialize istrold cccccccccccccccccccccc
cc otherwise recombination source distribution not updated cc
      istrold=-1
...
! yannick modified (NCELL -> NRCELL, in case NLTRA on)
! NRCELL is defined l. 683 by call to EIRENE_NCELLN
...
!          Y3=YTRIAN(NECKE(3,NCELL))
           X1=XTRIAN(NECKE(1,NRCELL))
           X2=XTRIAN(NECKE(2,NRCELL))
           X3=XTRIAN(NECKE(3,NRCELL))
           Y1=YTRIAN(NECKE(1,NRCELL))
           Y2=YTRIAN(NECKE(2,NRCELL))
           Y3=YTRIAN(NECKE(3,NRCELL))
        ENDIF
        Z1=0.
        Z2=0.
        Z3=0.
