...
C
      ...
      USE EIRMOD_CSPEI
c yannick
      use styx2eirene, only : Sn_tot_eirene,SE_tot_eirene, 
     .				 SEi_tot_eirene, SEi_in
...
C     ENDIF
     ...
     .  ('TOTAL LOSS  ---   TOTAL GAIN                   ')
      ...
      CALL EIRENE_LEER(2)
c yannick total electron loss <0 
      SE_tot_eirene = ELOSSE
