...
C
     ...
     .               NR1TAL,NP2TAL,NT3TAL,NBMLT)
      ...
      IF (LEAPL) THEN
        ...
        CALL EIRENE_INTTAL (DUMMY,VOLTAL,1,1,NSBOX_TAL,EAPLI(ISTRA),
     .               NR1TAL,NP2TAL,NT3TAL,NBMLT)
     ...
     .               NR1TAL,NP2TAL,NT3TAL,NBMLT)
      ...
      IF (LEMPL) THEN
        ...
        CALL EIRENE_INTTAL (DUMMY,VOLTAL,1,1,NSBOX_TAL,EMPLI(ISTRA),
     .               NR1TAL,NP2TAL,NT3TAL,NBMLT)
     ...
     .               NR1TAL,NP2TAL,NT3TAL,NBMLT)
      ...
      IF (LEIPL) THEN
        ...
        CALL EIRENE_INTTAL (DUMMY,VOLTAL,1,1,NSBOX_TAL,EIPLI(ISTRA),
     .               NR1TAL,NP2TAL,NT3TAL,NBMLT)
     ...
     .               NR1TAL,NP2TAL,NT3TAL,NBMLT)
      ...
      IF (LEPHPL) THEN
        ...
        CALL EIRENE_INTTAL (DUMMY,VOLTAL,1,1,NSBOX_TAL,EPHPLI(ISTRA),
     .               NR1TAL,NP2TAL,NT3TAL,NBMLT)
     ...
     .               NR1TAL,NP2TAL,NT3TAL,NBMLT)
      ...
      IF (LEPPL) THEN
        ...
        CALL EIRENE_INTTAL (DUMMY,VOLTAL,1,1,NSBOX_TAL,EPPLI(ISTRA),
     .               NR1TAL,NP2TAL,NT3TAL,NBMLT)
