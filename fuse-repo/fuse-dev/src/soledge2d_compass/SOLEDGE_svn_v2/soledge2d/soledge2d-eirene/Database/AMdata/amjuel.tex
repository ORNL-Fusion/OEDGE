%CSW changed from latex2.0.9 to latex2e (needed for usepackage-command)
...
(i.e. H.8 2.1.5G out).
 ...
 \item update  14.01/07 H.10, 2.1.8-t: for comparison with ADAS PRB \\
  ...
  to be done: H.10 2.1.8 H.12 2.1.5de  (JH to be replaced by FU)
\end{itemize}
\newpage
...
\subsubsection{H.0: interaction potentials}\label{sec1.3.1}
\subsubsection{H.1: cross section vs. energy}\label{sec1.3.2}
\subsubsection{H.2: rate coefficient vs. temperature (zero beam energy)}
...
Same expression of fit as in Section \ref{sec1.3.3}, but with energy $E$ (eV) replaced by
density $n$. The density $n$ in this fit must be given in $10^8 cm^{-3}$, i.e., in $cm^{-3}$ and then divided by
$10^8$, or in $m^{-3}$ and then divided by 100.
...
these are total energy loss rate coefficients associated
...
then these total effective rates include also line- (bound-bound) and continuum
(free-bound) radiation losses, kinetic energy of
products (e.g. in case of dissociation processes) and
internal (potential) energy
differences between pre- and post collision particles,
but {\bf not} bremsstrahlung (free-free) losses.
...
\end{verbatim}\end{small}
Competing process at low T: see above
...
and Jones rate for electron impact ionization of helium atoms \cite{kn:Freeman} .
...
Reaction 3.2.3  $  p + H_2(\nu) \rightarrow H + H_2^+  $
  ...
  vibrational distribution $H2(v)$ is density independent, assume: $T_e = T_p = T$

  hence: function of $E_{beam} = E_{H2}$ and T
\begin{small}\begin{verbatim}
        E-Index:     0                     1                     2
  T-Index:
        0   -9.645230885771D+03   -3.312562293674D+03   -4.642008863875D+02
        1    9.635139317586D+02    1.431209981817D+02   -1.623113446476D+01
        2   -3.238552524703D+02   -1.045021110299D+02   -1.247030415569D+01
        3   -7.958948816096D+01   -1.564243498893D+01   -8.126692776267D-01
        4    1.795249783907D+01    4.608298344746D+00    3.409881486918D-01
        5    3.327095557246D+00    3.248359051912D-01   -2.959384898339D-02
        6   -4.996203651405D-01   -7.156952880369D-02    1.244172796212D-03
        7   -1.042737933528D-01   -2.286145982917D-02   -1.923616091088D-03
        8    7.531901795379D-03    9.800034496803D-04   -2.725923286539D-05

        E-Index:     3                     4                     5
  T-Index:
        0   -3.341516413973D+01   -1.253133090148D+00   -1.969917158282D-02
        1   -5.063990966680D+00   -4.479998578191D-01   -1.834077278807D-02
        2   -6.865550615891D-01   -1.928755581441D-02   -4.268078616899D-04
        3    2.143166881350D-02    3.497082036304D-03    1.578307875059D-04
        4   -2.095566222471D-04   -7.255924192706D-04   -3.707123917753D-06
        5   -4.145707357196D-03   -7.361702041078D-05    5.249460348237D-06
        6    4.659917001708D-04    3.904853189629D-06   -6.450609749607D-07
        7   -6.403548983914D-05    7.574816575503D-07    7.494387755209D-08
        8   -9.947192276480D-06   -5.919454475128D-07   -1.962353959902D-08

        E-Index:     6                     7                     8
  T-Index:
        0    6.484329142648D-05    3.673451315592D-06   -9.872104337110D-09
        1   -3.261356373574D-04   -8.929589681768D-07    2.353018979277D-08
        2   -4.544184994978D-06    5.951797088816D-07    1.949475247030D-08
        3    5.690389745524D-06    1.553911576456D-07    1.720385042997D-09
        4    3.068887469389D-07   -5.270953529262D-08   -1.818374530299D-09
        5    2.757680430193D-07    1.117682102273D-08    2.740369015702D-10
        6    3.398565803833D-08    2.670966708170D-09    3.346957195127D-11
        7   -1.467276797896D-09   -9.460129351949D-11   -1.542043001723D-13
        8   -9.289671920073D-10   -4.157042085906D-11   -7.220730215109D-13

  Max. rel. Error:  12.4260 %
  Mean rel. Error:   5.1714 %

\end{verbatim}\end{small}
\begin{figure} \label{3.2.3b}
\epsfxsize=16truecm
\epsffile{Amjuel_PS/ionconv3.ps}
\end{figure}
\newpage
...
\section{H.8 : Fits for $\langle\sigma \cdot v \cdot E_{kin} \rangle (T) \ [cm^3/s
\cdot eV]$}
...
\subsection{
Reaction 2.0a   Ratio $H_2^+/H_2,$ only from  CX on cold $H_2(v)$
}
...
\subsection{
Reaction 2.0b   Ratio $H_2^+/H_2,$ only from CX on cold $H_2(v=0)$
}
(coll. model for vibr. excitation, Greenland, Reiter, \cite{kn:Green})
same as 2.0a, but cx (ion conversion) only from vibr. ground state
...
\subsection{
Reaction 7.0a      Ratio $H^-/H_2, H_2: $ from DA on $H_2(v)$
}

  (coll. model for vibr. excitation, Greenland, Reiter, \cite{kn:Green})\\
  Ratio of densities: $n_{H^-}/n_{H_2}$. Vibrational distribution $H_2(v)$ evaluated
  at $E_{H_2} = 0.1 eV$, $T_p = T_e$ and $n_p = n_e$.\\
  Production of $H^-$ from $H_2(v)$:    \\
...
\subsection{
Reaction 7.0b      Ratio $H^-/H_2, H_2: $ only from DA on $H_2(v=0)$
}
...
Reaction 2.0b Ratio $H_2^+/H_2$, from EI plus CX on cold $H_2(v=0)$
 ...
 Data: T.Fujimoto, P.T. Greenland
  ...
  only contribution from  EI on $H_2$ and $H_2^*$  and from CX on cold $H_2(v=0)$,
($E_{H_2}(v)=0.1$ eV)
