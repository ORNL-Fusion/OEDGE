...
c yannick
      zdum=0._dp
      CALL EIRENE_VELOCS
     .  (TWALL,zdum,zdum,zdum,zdum,zdum,RSQDV,CVRSS,
     .             -CRTX,-CRTY,-CRTZ,
     .             ESPTP,VXSPTP,VYSPTP,VZSPTP,VSPTP)

c      CALL EIRENE_VELOCS
c     .  (TWALL,0._DP,0._DP,0._DP,0._DP,0._DP,RSQDV,CVRSS,
c     .             -CRTX,-CRTY,-CRTZ,
c     .             ESPTP,VXSPTP,VYSPTP,VZSPTP,VSPTP)
...
c     .  (TWALL,0._DP,0._DP,0._DP,0._DP,0._DP,RSQDV,CVRSS,
c     .             -CRTX,-CRTY,-CRTZ,
c     .             ESPTC,VXSPTC,VYSPTC,VZSPTC,VSPTC)
