...
*******************************************************************************
      ...
      FUNCTION EIRENE_S13AAF(X,IFAIL)
...
C     .. External Functions ..
      INTEGER              EIRENE_P01ABE
      EXTERNAL             EIRENE_P01ABE
...
C
C
      EIRENE_S13AAF = EXP(-X)*Y/X
      RETURN
C
C     ASYMPTOTIC RANGE
   40 EIRENE_S13AAF = 0.0
      RETURN
C
C     ERROR EXIT
   60 IFAIL = EIRENE_P01ABE(IFAIL,1,SRNAME,0,P01REC)
      EIRENE_S13AAF = 0.0
      RETURN
C
      END
