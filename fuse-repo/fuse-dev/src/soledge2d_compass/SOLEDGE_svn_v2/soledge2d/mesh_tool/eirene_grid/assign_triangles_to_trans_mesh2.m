            ...
            if(((zone(k).chi2(i+1,j+1)==0)&&(zone(k).chi2(i+1,j+2)==1))||...
                ...
                while(pointOK==0)
                    ...
                    for n=1:ncase
                        ...
                        j_2=j_;
                        k_2=k_;
                        i_=zone(k_2).point_west(i_2,j_2).i;
                        j_=zone(k_2).point_west(i_2,j_2).j;
                        k_=zone(k_2).point_west(i_2,j_2).k;
                        %test proximite
                        if(k_==0)
                            break
                        end
                    ...
                    for n=1:ncase
                        ...
                        j_2=j_;
                        k_2=k_;
                        i_=zone(k_2).point_est(i_2,j_2).i;
                        j_=zone(k_2).point_est(i_2,j_2).j;
                        k_=zone(k_2).point_est(i_2,j_2).k;
                        %test proximite
                        if(k_==0)
                            break
                        end
                    ...
                    if(m==0)
                        ...
                        zone(k).list_tri(i,j).nums=list_tri;
                    end
                end
            end
        end
